      ...
      <div className="hidden lg:flex flex-col justify-between w-80 shrink-0 p-10" style={{ backgroundColor: '#2C3E50' }}>
        <div>
          <div className="bg-white px-4 py-3 inline-block">
            <img src="/salt-air-logo-web.png" alt="Salt Air Cleaning" className="h-28 w-auto" />
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="lg:hidden text-center">
            <img src="/salt-air-logo-web.png" alt="Salt Air Cleaning" className="h-40 w-auto mx-auto" />
          </div>
                ...
                <TabsContent value="password">
                  <form onSubmit={handleEmailLogin} className="space-y-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <Label htmlFor="remember-me" style={{ color: '#4A5A65' }} className="text-sm font-normal cursor-pointer">
                        Stay signed in
                      </Label>
                    </div>
                    <Button
